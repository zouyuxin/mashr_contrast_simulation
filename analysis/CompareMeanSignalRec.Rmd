...
barplot(c(sqrt(mean((delta.10 - m.1by1$result$PosteriorMean)^2)/mean((delta.10 - deltahat.10)^2)),
          ...
          sqrt(mean((delta.1 - Mis.model.1.full$result$PosteriorMean)^2)/mean((delta.1 - deltahat.1)^2))), ylim=c(0,0.3), names.arg = c('ash','mashcommon.10','mashcommon.1','mash.indep.10', 'mash.indep.1', 'mis.10', 'mis.1'), ylab='RRMSE')
```
...
legend('bottomright', c('mashcommon.1','mashcommon.10', 'mash.indep.1', 'mash.indep.10', 'mis.1', 'mis.10', 'ash'),col=c('red','green', 'blue', 'black', 'brown', 'cyan', 'darkgreen'),lty=c(1,1,1,1,1,1,1))}
```
